...
variable "high_blocked_transactions_threshold" {
  description = "The minimum number of CPU credits (t2 instances only) available."
  type        = string
  default     = 30
}

variable "low_freeable_memory_threshold" {
...
variable "low_free_storage_space" {
...
variable "high_db_connections_threshold" {
  description = "The minimum number of db connections"
  type        = string
  default     = 300
}

variable "high_select_latency_threshold" {
  description = "Maximum select latancy"
  type        = string
  default     = 20
}
variable "high_insert_latency_threshold" {
  description = "Maximum insert latancy"
  type        = string
  default     = 20
}
